import { Avatar, Card, CardActionArea, CardActions, CardContent, CardHeader, CardMedia, Hidden, IconButton, Typography } from "@mui/material";
...
const PetCard = (props) => {
    ...
    return (
        <Card className={style.card} sx={{ width: "100%", height: "100%", maxHeight: "460px" }}>
            <CardActionArea>
