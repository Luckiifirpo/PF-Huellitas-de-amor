    ...
    return <Box>
        <Paper sx={{ padding: "20px" }}>
            <Grid container spacing={2}>
                ...
                <Grid item md={12}>
                    <TextField size="small" onChange={(event, value) => {OnChange(event, value, false)}} value={data.name} type={"text"} name="name" label={"Nombre:"} sx={{ width: "100%" }} />
                </Grid>
                <Grid item md={12}>
                    <TextField size="small" onChange={(event, value) => {OnChange(event, value, false)}} value={data.surname} type={"text"} name="surname" label={"Apellido:"} sx={{ width: "100%" }} />
                </Grid>
                <Grid item md={12}>
